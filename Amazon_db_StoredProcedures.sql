...
BEGIN
    ...
    IF v_count > 0 THEN
        ...
        RAISE NOTICE '✅ Product "%": Sale added and inventory updated.', v_product;
    ELSE
        RAISE NOTICE '❌ Product "%": Not enough stock to complete the sale.', v_product;
    END IF;
END;
$$;
...
-- Call procedure with example values
CALL add_sales(
    25005,  -- order_id
    2,      -- customer_id
    5,      -- seller_id
